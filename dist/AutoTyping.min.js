...
return null!=this.currCorpus&&(this.currCorpus.hasNext()||this.corpusArr.length>0)},t.prototype.doNext=function(){return!!this.hasNext()&&(this.currCorpus.doNext(),this.hasNext())},t.removePattern=new RegExp("^\\^#\\d+#\\^$"),t.waitPattern=new RegExp("^\\^@\\d+@\\^$"),t}(),u=function(){function t(t,e,r,n,i){var s=this
this.corpusManager=new p(e,t),this.type=r==o.default?o.timer:r,this.stopped=!1,this.strokeSpeed=n,this.callback=i,this.strokeListener=function(){if(!s.stopped)for(var t=0;t<s.strokeSpeed;t++)s.next()}}return t.prototype.next=function(){this.corpusManager.doNext()||(console.log("complete corpus managed."),this.stop(),"function"==typeof this.callback&&this.callback())},t.prototype.start=function(){switch(this.stopped=!1,this.type){case o.keyStroke:document.body.addEventListener("keyup",this.strokeListener,!1)
break
case o.timer:this.timerCaller()}},t.prototype.timerCaller=function(){var t=this
this.appTimerToken=setTimeout(function(){t.stopped||requestAnimationFrame(function(){t.next(),t.timerCaller()})},100*this.strokeSpeed)},t.prototype.stop=function(){switch(this.type){case o.keyStroke:this.stopped=!0,document.body.removeEventListener("keyup",this.strokeListener,!1)
break
